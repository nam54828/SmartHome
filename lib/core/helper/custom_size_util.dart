...
mixin CustomSizeUtil {
  ...
  /// Get type of device.
  ///
  static TypeOfDevice getTypeOfDevice() {
    if (ScreenUtil().screenHeight <= 740) {
      return TypeOfDevice.smallDevice;
    }

    return TypeOfDevice.normalDevice;
  }
  ...
  static const double SPACE_8X = 50;
