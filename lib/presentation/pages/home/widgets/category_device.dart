...
class CategoryDevice extends StatefulWidget {
  ...
  final bool initialSwitchValue;
   CategoryDevice({Key? key, required this.text, required this.color, required this.onTap, required this.initialSwitchValue, required this.icon}) : super(key: key);
    ...
    return  GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
           Padding(
             padding: const EdgeInsets.only(top: CustomSizeUtil.SPACE_3X, left: CustomSizeUtil.SPACE_3X),
             child: Row(
               children: [
                 Container(
                   width: 28.w,
                   ...
                   child: Icon(
                     IconData(widget.icon, fontFamily: 'MaterialIcons'), // Sử dụng fontFamily phù hợp
                     color: Colors.white,
                     size: 16,
                   ),
                 ),
